...
bool TextReader::handleInput(u64 keysDown, u64 keysHeld, const HidTouchState &touchPos, HidAnalogStickState leftJoyStick, HidAnalogStickState rightJoyStick) {
    if (keysHeld & HidNpadButton_ZR) {
        if (keysHeld & HidNpadButton_StickL && leftJoyStick.y < -10)
            scrollTo(0);
        if (keysHeld & HidNpadButton_StickL && leftJoyStick.y > 10)
            scroll(m_totalLines);
        if (keysHeld & HidNpadButton_StickL && leftJoyStick.x < -10)
            scroll(-1000);
        if (keysHeld & HidNpadButton_StickL && leftJoyStick.x > 10)
            scroll(1000);
    }
    ...
    if (keysHeld & HidNpadButton_StickR && rightJoyStick.y < -10)
        scroll(-1);
    if (keysHeld & HidNpadButton_StickR && rightJoyStick.y > 10)
        scroll(1);
    if (keysHeld & HidNpadButton_StickR && rightJoyStick.x < -10)
        m_panx++;
    if (keysHeld & HidNpadButton_StickR && rightJoyStick.x > 10)
        m_panx--;
